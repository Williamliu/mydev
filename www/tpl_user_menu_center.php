...
<?php 
$html = '';
$query_mm = "SELECT * FROM vw_user_menu WHERE session_id = '" . $public_user["sessid"] . "'";
...
/*
$html .= '<li class="selected"><div>' . $words["my message"] . '</div>';
$html .= '<ul>';
$html .= '<li>';
$html .= '<a href="mymessage_inbox.php" title="' . $words["my message inbox"] . '">' . $words["my message inbox"] . '</a>';
$html .= '</li>';
$html .= '<li>';
$html .= '<a href="mymessage_outbox.php" title="' . $words["my message outbox"] . '">' . $words["my message outbox"] . '</a>';
$html .= '</li>';
$html .= '</ul>';
*/
