                    ...
                    '<span>',
                        ...
                        '<div style="display:inline-block;position:relative;min-width:{{minww}}px;min-height:{{minhh}}px;border:1px solid #cccccc;" class="wliu-background-1" >',
                            ...
                            '<div style="display:table-cell;vertical-align:middle;text-align:center;width:{{ww}}px;height:{{hh}}px;" class="img-content" targetid="{{imgviewerid}}">',
                                '<img class="img-responsive" width="100%" style="display:inline-block;" ng-click="clickImage()" onload="imageAutoFix(this)" ww={{ww}} hh={{hh}} src="{{table.getColCurrent(name).value?table.getColCurrent(name).value:\'\'}}" />',
                            '</div>',
                            '<div>',
                            '<input type="hidden" ',
                                'ng-model="table.getColCurrent(name).value" ',
                        ...
                        '<div style="display:inline-block;position:relative;min-width:{{minww}}px;min-height:{{minhh}}px;border:1px solid #cccccc;"  class="wliu-background-1">',
                            ...
                            '<div style="display:table;">',
                                '<div style="display:table-cell;vertical-align:middle;text-align:center;width:{{ww}}px;height:{{hh}}px;" class="img-content" targetid="{{imgeditorid}}">',
                                    '<img class="img-responsive" width="100%" style="display:inline-block;" ng-click="clickImage()" onload="imageAutoFix(this)" ww={{ww}} hh="{{hh}}" style="cursor:pointer;" src="{{table.getColCurrent(name).value?table.getColCurrent(name).value:\'\'}}" />',
                                '</div>',
                            '</div>',
                    ...
                    '<span>',
                        ...
                        '<div ng-click="showEsign()" style="display:inline-block;position:relative;min-width:{{minww}}px;min-height:{{minhh}}px;border:1px solid #cccccc;" class="wliu-background-11" >',
                            ...
                            '<div style="display:table-cell;vertical-align:middle;text-align:center;width:{{minww}}px;height:{{minhh}}px;" class="esign-content" targetid="{{esignDivid}}">',
                                '<img class="img-responsive" width="100%" style="display:inline-block;" onload="imageAutoFix(this)" ww={{minww}} hh={{minhh}} src="{{table.getColCurrent(name).value?table.getColCurrent(name).value:\'\'}}" />',
                            '</div>',
                            '<input type="hidden" ',
                                'ng-model="table.getColCurrent(name).value" ',
                                form_scope,
    ...
    return {
        ...
        template: [
                    '<span class="wliuCommon-label" ',
                        form_ng_hide,
                    '>',
                    '{{ table.getColCurrent(name).value?(table.getColCurrent(name).value>0?(table.getColCurrent(name).value * 1000 | date : (format?format:"yyyy-MM-dd HH:mm") ):"") :"" }}',
                    '</span>'
				  ].join(''),
        controller: function ($scope) {
        }
