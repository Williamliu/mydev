        ...
        <script language="javascript" type="text/javascript">
            ...
            app.controller("webAdmin", function ($scope, wmliuTableService, wmliuSearchService) {
                $scope.table = {
                    ...
                    schema: {
                        table: {
                            sstable: { name: "public_seo", col: "id", val: "" }
                        },
                        cols:
                            [
								...
								{ col: "template", 		type: "textbox", title: words["template"], 			sort: "asc", css: "", align: "left", valign: "top", width: 80, maxlength: 256 },
                                { col: "seo_title", 	type: "textarea", 	title: words["seo.title"], 		sort: "asc", width:160, required: 1 },
                                { col: "seo_keyword", 	type: "textarea", 	title: words["seo.keyword"], 	sort: "asc", width:200 },
                                { col: "seo_description",type: "textarea", 	title: words["seo.desc"], 		sort: "asc", width:200},
                                { col: "seo_class",		type: "textarea", 	title: words["seo.class"], 		sort: "asc", width:120},
