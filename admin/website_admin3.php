...
<head>
		...
		<script type="text/javascript" 	src="<?php echo $CFG["web_domain"]?>/jquery/myplugin/jquery.lwh.imagelist.js"></script>
        <link 	type="text/css" 	   href="<?php echo $CFG["web_domain"]?>/jquery/myplugin/css/light/jquery.lwh.imagelist.css" rel="stylesheet" />
		...
		<script type="text/javascript" 	src="<?php echo $CFG["web_domain"]?>/jquery/myplugin/jquery.lwh.imagesrc.js"></script>
        ...
        <script language="javascript" type="text/javascript">
			...
			$(function(){
				iupload = new LWH.AjaxImage({
									...
									after:		function(obj) {
										if(obj.errorCode <= 0 ) {
											...
											isrc.refid(obj.data.imgObj.id);
										}
									}
								});
	  			$(".lwhTab3").lwhTab3();

				ipic = new LWH.ImageList({name:"productImage", filter:"product", mode:"medium", view:"tiny", lang:GLang, tips:true, noimg:0, container:"#imgshow",edit:true, ww:640, hh:400, imgww:150,imghh:120, orient:"hv",
											click: function(imgObj) {
												isrc.imgid(imgObj.id);
											}
										});
				...
				isrc = new LWH.ImageSRC({name:"myimg", filter:"product", lang:GLang, mode:"medium", imgel:"#img_lwh", cache: true, tips: true, ajax:true, noimg:0, imgww: 250,imghh:250,
...
<!------------------------------------------------ Begin of website content --------------------------------------------->
    ...
    <input type="button" onclick="mmclear();" value="Clear" />
    <img id="img_lwh" src="" />
	</div>
