            ...
            app.controller("webAdmin", function ($scope, $http, $cookieStore, wmliuTreeService) {
                ...
                $scope.tree = {
                    ...
                    schema: {
                        ...
                        checklist: {
                            menu_right_id: 	{ rtable: "user_menu_right", 		rcol: "menu_id", ltable: "", stable: "website_right", scol: "id", stitle: langCol("title", GLang), sdesc: langCol("desc", GLang) },
                            temp_right_id: 	{ rtable: "user_template_right", 	rcol: "temp_id", ltable: "", stable: "website_right", scol: "id", stitle: langCol("title", GLang), sdesc: langCol("desc", GLang) }
                        },
                        listTables: {
                        }
                    },
