            ...
            app.controller("webAdmin", function ($scope, $http, $cookieStore, wmliuListService, wmliuFormService, wmliuTreeService) {
                $scope.tree = {
                    ...
                    schema: {
                        ...
                        checklist: {
                            menu_right_id: 	{ atable: "website_menu_right", acol:"menu_id", stable: "website_right", scol: "id", stitle: langCol("title", GLang), sdesc: langCol("desc", GLang) },
                            temp_right_id: 	{ atable: "website_template_right", acol:"temp_id", stable: "website_right", scol: "id", stitle: langCol("title", GLang), sdesc: langCol("desc", GLang) }
                        },
                        listTables: {
                        }
                    },
                ...
                $scope.groupList = {
                    schema: {
                        table: {
                            pptable: { name: "website_group", col: "id", val: "" }
                        },
                        cols: [
                                { col: "", type: "rowno" },
                ...
                $scope.groupForm = {
                    buttons: {
                        ...
                        rights: GUserRight   // {"add":1, "save":1,"cancel":1, "delete":1}
                    },
                    schema: {
                        table: {
                            sstable: { name: "website_group", col: "id"}
                        },
                        checklist: {
                    ...
                    detail: {
                        ...
                        cols: {
							...
							group_id:	{ type: "treecheck", 
												tree: {
													menu_right_id: { table: "website_group_menu", 		col: "menu_id", 	val: "right_id" },
													temp_right_id: { table: "website_group_template", 	col: "temp_id", 	val: "right_id" }
												}
										},
...
<!------------------------------------------------ Begin of website content --------------------------------------------->
    <div ng-controller="webAdmin" >
		<table>
        	<tr>
            	<td valign="top">
                     <div class="lwhTab9 lwhTab9-salmon">
                        <ul>
            	...
            	<td valign="top" style="padding-left:20px;">
                             <div class="lwhTab9 lwhTab9-brown">
                                <ul>
