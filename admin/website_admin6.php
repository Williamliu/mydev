...
<head>
        ...
        <script language="javascript" type="text/javascript">
			...
			$(function(){
				...
				ipic = new LWH.ImageVShow({name:"productImage", filter:"admin photo", mode:"medium", view:"tiny", orient:"hv", noimg:0, container:"#imgshow",edit:true, ww:600, hh:360});

	  			$(".lwhTab3").lwhTab3();

				
				/*
				ipic = new LWH.ImageShow({
											name:"productImage", 
											filter:"product", 
											mode:"medium", 
											view:"large", 
											...
											after: function(s, l) {
												if( l.length > 0 ) {
													for(var i = 0; i < l.length-1; i++) {
														var bimg = '<li><img src="' + l[i].raw[s.mode] + '" title="' + l[i].title + '" /></li>';
														$("ul.bxslider").append(bimg);
													}
													if( slider == null ) {
											...
											append: function(s, l, o) {
												$('ul.bxslider').append('<li><img src="' + o.raw[s.mode] + '" title="' + o.title + '" /></li>');
												if( slider == null ) {
													slider = $('.bxslider').bxSlider({
														  mode: 	'fade',
														  pause:	3000,
