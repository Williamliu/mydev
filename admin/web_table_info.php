...
<head>
        ...
        <script language="javascript" type="text/javascript">
		   	var col1 = new WLIU.COL({key:1, coltype:"hidden", 		name:"tid", 		col:"id", 	colname:"Table ID",  	coldesc:"Table ID", defval: "" });
		   	var col2 = new WLIU.COL({key:0, coltype:"textbox", 		name:"table_name",	colname:"Table Name", 	coldesc:"Table Name" });
		   	var col3 = new WLIU.COL({key:1, coltype:"hidden", 		name:"bid", 		col:"id", 	    colname:"Info ID",  coldesc:"Info ID", 	defval:"" });
		   	var col4 = new WLIU.COL({key:0, coltype:"hidden", 		name:"ref_tid", 	col:"ref_id",   colname:"Ref ID",  	coldesc:"Ref ID", 	defval:"" });
		   	var col5 = new WLIU.COL({key:0, coltype:"textbox", 		name:"title_en", 	colname:"Title.EN", 	coldesc:"Title English",  		sort:"ASC", maxlength:64, 	notnull:1, unique:1	});
		   	var col6 = new WLIU.COL({key:0, coltype:"textbox", 		name:"title_cn", 	colname:"Title.CN", 	coldesc:"Title Chinese",  		sort:"ASC", maxlength:64,  	notnull:1,  });
		   	var col7 = new WLIU.COL({key:0, coltype:"textarea", 	name:"desc_en", 	colname:"Detail.EN",   	coldesc:"Description English",	sort:"ASC", maxlength:256 });
		   	var col8 = new WLIU.COL({key:0, coltype:"textarea", 	name:"desc_cn", 	colname:"Detail.CN",   	coldesc:"Description Chinese",	sort:"ASC", maxlength:256 });
		   	var col9 = new WLIU.COL({key:0, coltype:"bool", 		name:"status",		colname:"Active?",  	coldesc:"Active Status", 		defval: true});
		   	var col10 = new WLIU.COL({key:0, coltype:"textbox", 		name:"orderno", 	colname:"Order", 		coldesc:"Order No.",  		sort:"Desc", min:1, max:999, defval:"0", datatype:"NUMBER" });
		...
		<div class="row">
			...
			<table class="table table-condensed">
				...
				<tr ng-repeat="row in web_table.rows">
					...
					<td width="100px">
						<table.text class="input-auto" table="web_table" name="table_name" rowsn="{{$index}}"></table.text>
					</td>
					<td width="100px">
					...
					<td>
						<table.textbox class="input-large" table="web_table" name="desc_en" rowsn="{{$index}}"></table.textbox>
					</td>
					<td>
						<table.textbox class="input-large" table="web_table" name="desc_cn" rowsn="{{$index}}"></table.textbox>
					</td>
					<td>
