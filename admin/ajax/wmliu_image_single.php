...
try {
	...
	if( $_REQUEST["schema"]["ref_id"] != "" ) 
		$imgid = $upload->MainID();
	else 
		$_REQUEST["schema"]["ref_id"] = $upload->imgid2refid($_REQUEST["schema"]["imgid"]);
	 
	$_REQUEST["schema"]["imgid"]	=$_REQUEST["schema"]["imgid"]?$_REQUEST["schema"]["imgid"]:$imgid;
