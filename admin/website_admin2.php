...
<head>
		...
		<script type="text/javascript" 	src="<?php echo $CFG["web_domain"]?>/jquery/myplugin/jquery.lwh.imagewshow.js"></script>
	    ...
	    <script type="text/javascript" src="<?php echo $CFG["web_domain"]?>/jquery/plugin/bxslider/jquery.bxslider.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo $CFG["web_domain"]?>/jquery/plugin/bxslider/jquery.bxslider.css" />
        ...
        <script language="javascript" type="text/javascript">
			...
			$(function(){
				...
				//ipic = new LWH.ImageBox({name:"productImage", filter:"product", mode:"small", view:"medium", container:"#imgshow",edit:true, ww:200, hh:160, imgww:160,imghh:120, orient:"h"});
				
				ipic = new LWH.ImageWShow({
											name:"productImage", 
											filter:"product", 
											mode:"medium", 
											view:"tiny", 
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	...
                                        	<div id="imgshow" style="display:block; width:600px; height:200px;"></div>
                                        </td>
                                    </tr>
								</table>                     
                </td>
