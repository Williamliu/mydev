...
<head>
        ...
        <script language="javascript" type="text/javascript">
		   	...
		   	var col6 = new WLIU.COL({key:0, table:"p",	coltype:"textbox", 		name:"orderno", 	colname:"Sort", 			sort:"ASC", maxlength:3, 	notnull:1, datatype:"NUMBER" });
		   	var col7 = new WLIU.COL({key:0, table:"p",	coltype:"bool", 		name:"status",		colname:"Active?",  		defval: 1});
		   	var col8 = new WLIU.COL({key:0, table:"p",	coltype:"text", 		name:"last_updated",colname:"Last Updated", sort:"DESC"});
